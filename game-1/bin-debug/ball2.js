...
var ball2 = (function (_super) {
    ...
    ball2.prototype.partAdded = function (partName, instance) {
        _super.prototype.partAdded.call(this, partName, instance);
    };
    ball2.prototype.childrenCreated = function () {
        _super.prototype.childrenCreated.call(this);
        this.btn_start.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onButtonClick, this);
    };
    //点击神棍，足球开始缓动
    ball2.prototype.onButtonClick = function (e) {
        switch (this.i) {
            case 1://开始游戏
                this.ballTween();
                this.i++;
     ...
     * 足球缓动
     */
    ball2.prototype.ballTween = function () {
        var _this = this;
...
__reflect(ball2.prototype, "ball2", ["eui.UIComponent", "egret.DisplayObject"]);
